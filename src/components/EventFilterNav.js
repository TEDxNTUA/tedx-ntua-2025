...
const links = [
  // {href: '/event/program', label: 'Program', colorKey: 'synelixis-blue'},
...
export default function EventFilterNav() {
  ...
  return (
    <nav className="flex flex-wrap justify-center gap-4 p-4 bg-gray-100 border-b border-gray-300 pb-6 mx-auto">
      {links.map(link => {
        const isActive =
